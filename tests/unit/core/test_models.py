...
from govbr_auth.core.errors import ExpiredTransactionError, InvalidIdTokenError, InvalidStateError
from govbr_auth.core.models import AuthTransaction, GovBrUser, TokenSet
...
def test_auth_errors_expose_stable_code(error_type: type[Exception], expected_code: str) -> None:
